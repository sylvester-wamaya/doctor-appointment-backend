...
Doctor.create(name: 'clint', specialization: 'surgery', consultation_fee: 4, prescription_fee: 5, photo: "url")
Doctor.create(name: 'clinton', specialization: 'surgery', consultation_fee: 4, prescription_fee: 5, photo: "url")
